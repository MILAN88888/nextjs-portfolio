  ...
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-content flex-col items-center justify-center px-5 py-20 text-center md:px-8">
      ...
      <button
        type="button"
        onClick={reset}
        className="mt-8 inline-flex items-center gap-2 rounded border border-transparent bg-accent px-4 py-3 text-small font-medium text-accent-fg transition-all duration-200 hover:brightness-110"
      >
        Try again
      </button>
    </div>
